/* The same problem as test10c.c, but keeping the order of objects.
 * You can look at it also as recoding test10b.c in C++, using double tree.
 * The result should be the same as for test0b.c */
...
ZZ_HYPER_DOUBLE_TREE(tree,Node);

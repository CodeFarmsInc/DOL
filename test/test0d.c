 ...
 * functions ZZ_ADD and ZZadd are used, and the whole organization
 * is saved on an ASCII file, then removed from memory, restored,
 *  and the results are calculated from there.
 * This is a fairly good test of ZZ_SAVE() and ZZ_OPEN() for ASCII files.
 * The result must be identical with test0a.c
 * The program also tests the use of ZZerror for ZZ_OPEN().
 */
...
/* Borland 3.0 has a bug which requires zzfunc.c to be included
   before declaration of zz_out_.. and zz_inp_.. functions, and
   not at the end of the file.
   File zzfunc.c may be compiled separately without any problem 
*/
#include "zzfunc.c"
/* ===================================================== */
#ifdef ZZ_ANSI

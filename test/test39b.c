...
//
// This is a more complex test for compilers that can handle
// multiple inheritance, abstract classes, and virtual base classes.
// Note that due to the continuous changes in how new versions of compilers
// represent virtual base classes, for some compilers the mask is not
// valid any more.

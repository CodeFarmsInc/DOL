/* This is exactly the same program as test0i.c, except that
 * the COLLECTs has been replaced by TRIANGLES, and a binary
 * SAVE is being used. The results should be exactly the same.
 *
